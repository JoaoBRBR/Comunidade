...
if($foto["name"] == null){
        ...
        $consulta = "UPDATE noticiaY SET idNoticia='$novoid', titulo='$titulo', texto='$texto', data='$data' WHERE idNoticia='$id' ";
            ...
            $con->close();  /* fechar a ligação */
                ...
                echo "
                    ...
                    if (confirm('Atualizado com Sucesso!')) {
                        window.location.replace('../noticiasy.php');
                    }
                    </script>
                ";
        }
    ...
    if (($ext == "jpg") || ($ext == "jpeg") || ($ext == "png") || ($ext == "gif")) {
        ...
        /* texto sql da consulta*/
        $consulta = "UPDATE noticiaY SET idNoticia='$novoid', titulo='$titulo', texto='$texto', foto='$nomefoto', data='$data' WHERE idNoticia='$id' ";
